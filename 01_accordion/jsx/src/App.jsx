    ...
    (id) => {
      ...
      setActiveAccordions((prev) => {
        ...
        if (updatedActiveAccordions.has(id)) {
          ...
          // if it is not allowed to keep multiple accordions opened,
          // then on click of any accordion, at first we are closing all the opened ones
          ...
          // now we are adding that particular clicked accordion and we will be showing only one in this case.
